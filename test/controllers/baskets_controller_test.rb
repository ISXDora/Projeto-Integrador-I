...
class BasketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create basket" do
    assert_difference('Basket.count') do
      post baskets_url, params: { basket: { location_id: @basket.location_id, ribbon_id: @basket.ribbon_id } }
    end
  ...
  test "should update basket" do
    patch basket_url(@basket), params: { basket: { location_id: @basket.location_id, ribbon_id: @basket.ribbon_id } }
